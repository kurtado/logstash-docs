...
NOTE: This tutorial specifies running Logstash {logstash_version} with Elasticsearch {elasticsearch_version}. This version of Logstash should work with any version of Elasticsearch 1.x. For the latest version of Logstash visit the http://www.elasticsearch.org/overview/logstash[Logstash Overview] page.
